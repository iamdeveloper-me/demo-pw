...
@Component({
  selector: 'app-honeymoon-search-result',
  templateUrl: './honeymoon-search-result.component.html',
  styleUrls: ['./honeymoon-search-result.component.scss'],
  providers: [CustompipePipe, CategoryPipePipe, PaginationService]
})
export class HoneymoonSearchResultComponent implements OnInit {
...
// export class HoneymoonLocationsVM {
//   honeymoonLocationId: number;
//   name:	string;
//   countryId:	number;
//   country:Array<CountryVM>;
//   countrys:CountryVM;
//   districtId : number;
//   districts:Array<DistrictsVM>;
//   district:DistrictsVM;
//   suburb:Array<SuburbVM>;
//   suburbs:SuburbVM;
//   suburbId : number;
//   imageURL : string;
//   description :	string;
...
//   export class DistrictsVM {
//     districtId : number;
//     countryId	: number;
//     name :	string;
//   }

//   export class SuburbVM {
//     suburbId : number;
//     districtId : number;
//     name : string;
//   }